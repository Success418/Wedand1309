...
//            }
    ...
    private class sendNotification extends AsyncTask<String, Void, Bitmap> {
        ...
        protected void onPostExecute(Bitmap result) {
            ...
            if(DrawerActivity.drawerActivity !=null){
              ...
              View layout = DrawerActivity.drawerActivity.getLayoutInflater().inflate(R.layout.item_layout_custom_notification,null);
              ...
              snackbar = Snackbar.make(DrawerActivity.drawerActivity.findViewById(R.id.container), "", Snackbar.LENGTH_LONG);
               ...
               handler.postDelayed(runnable, 30000);
                ...
                layout.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        snackbar.dismiss();
                        snackbar.getView().setVisibility(View.INVISIBLE);
                        chatFragment(DrawerActivity.user_id,senderid,title);
    ...
    public void chatFragment(String senderid,String receiverid,String name){
        ...
        FragmentTransaction transaction = DrawerActivity.drawerActivity.getSupportFragmentManager().beginTransaction();
